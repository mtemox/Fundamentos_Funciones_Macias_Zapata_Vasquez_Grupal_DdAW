...
// ----------------------------------------------------------------
// 1. fundamentals - uso de una propiedad de los arreglos (.length)
// ----------------------------------------------------------------
console.log("--- Propiedad .length ---");
// La propiedad .length nos dice cuántos elementos hay en el arreglo.
console.log(`Tienes ${personas.length} sugerencias de amistad.`);
console.log("\n");
...
// ----------------------------------------------------------------
// 4. destructuring - destructuración de arreglos
// ----------------------------------------------------------------
console.log("--- Destructuración de Arreglos ---");
// Permite desempacar valores de arreglos en distintas variables.
const [primeraSugerencia, segundaSugerencia, terceraSugerencia] = personas;
console.log("Tu primera sugerencia es:", primeraSugerencia.nombre);
console.log("Tu segunda sugerencia es:", segundaSugerencia.nombre);
console.log("\n");
